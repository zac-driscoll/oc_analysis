...
author: "Freshwater Resource Monitoring"
date: "9/2/2021"
output: 
  html_document:
    code_folding: hide
...
mds_params <-
  param_lookup_table %>%
  filter(op_sid %in%
           c(877, 196, 192, 189, 75, 213, 183, 181,198)) %>% #TOC, NH3, NO3, TP, TSS
  pull(op_sid)
...
all_t_tests <-
  expand.grid(oc_sites, oc_sites, c(mds_params, 213, 880, 178, 182, 179, 
                                    75))
...
Temp, Chloride, and Turbidity.  Data were scaled by parameter groups using z scale 
